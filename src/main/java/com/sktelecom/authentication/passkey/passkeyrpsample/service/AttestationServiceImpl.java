...
public class AttestationServiceImpl implements AttestationService {
    ...
    public WebAuthnServerResponse<AttestationOptions> getOptions(AttestationOptionsServerRequest optionsRequest)
    	...
    	log.info("AttestationServiceImpl.getOptions()====================");
		...
		log.info("==> requestDto.getUser().getName() [암호화해서 ID생성] = " + requestDto.getUser().getName());
		log.info("==> requestDto.getUser().getId() = " + requestDto.getUser().getId());
